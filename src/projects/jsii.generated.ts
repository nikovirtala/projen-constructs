...
export class JsiiProject extends cdk.JsiiProject {
    ...
    constructor(options: JsiiProjectOptions) {
        ...
        const { mise, vitest, typeDoc, ...baseOptions } = options;
        ...
        applyDefaults(this, [{ component: Mise, enabled: mise }, { component: Vitest, enabled: vitest }, { component: TypeDoc, enabled: typeDoc }]);
    }
}